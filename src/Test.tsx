            ...
            <div className='space-y-8 text-center lg:text-left'>
              <div className='space-y-6'>
                ...
                <p className='text-xl text-blue-100 leading-relaxed max-w-2xl mx-auto lg:mx-0'>
                  Furimage Consult is strategic partner in public relations and
                  communications, crafting narratives that inspire, engage, and
                  drive meaningful connections with audience.
                </p>
              </div>
            ...
            <div className='space-y-8'>
              <div className='space-y-6'>
                ...
                <p className='text-lg text-gray-600 leading-relaxed'>
                  At Furimage Consult , we understand that in today's fast-paced
                  digital landscape, your reputation is your most valuable
                  asset. We specialize in strategic public relations and
                  communications that not only protect but enhance your brand's
                  image, identity, and influnce.
                </p>
              </div>
              <div className='space-y-6'>
      ...
      <footer className='bg-gray-900 text-white py-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='border-t border-gray-800 pt-8 text-center text-gray-400'>
            <p>
              &copy; 2026 Furimage Consult. All rights reserved. | Designed By
              <a
